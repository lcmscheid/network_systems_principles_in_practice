...
def recv_message(conn):
    ...
    version, data_length = struct.unpack("ii", header)
    print(f"Received header: version={version}, data_length={data_length}")
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                ret_val = make_call(json_dict)
                send_message(conn, {"status": "OK", "response": ret_val})
